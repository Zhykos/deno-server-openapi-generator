...
export class OakOpenApiRequest implements OpenApiRequest {
  ...
  constructor(context: RouterContext<string, any, Record<string, any>>) {
    const schema: OperationObject = {
      parameters: this.createParameters(context.params, context.request.url.searchParams),
    };
    this.openapi = {
      pathParams: this.createPathParameters(context.params, context.request.url.searchParams),
      schema: schema,
    };
  ...
  private createParameters(routeParams: any, urlParams: URLSearchParams): Array<ParameterObject> {
  ...
  private createParametersFromRoute(routeParams: any, allParameters: Array<ParameterObject>): void {
  ...
  private createParametersFromURL(urlParams: URLSearchParams, allParameters: Array<ParameterObject>): void {
  ...
  private createPathParameters(routeParams: any, urlParams: URLSearchParams): { [index: string]: string } {
  ...
  private createPathParametersFromRoute(routeParams: any, allParameters: { [index: string]: string }): void {
    for (const [key, value] of Object.entries(routeParams)) {
      allParameters[key as string] = value as string;
    }
  }

  private createPathParametersFromURL(urlParams: URLSearchParams, allParameters: { [index: string]: string }): void {
